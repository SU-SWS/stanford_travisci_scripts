...
if [ -z "$PRODUCT_NAME" ]; then
  ...
  git clone -b $DRUPAL_PROFILE_BRANCH --depth 1 https://github.com/SU-SWS/Stanford-Drupal-Profile.git $HOME/Stanford-Drupal-Profile
  ...
  git clone -b $DEPLOYER_BRANCH --depth 1 https://github.com/SU-SWS/stanford-jumpstart-deployer.git $HOME/stanford-jumpstart-deployer
