...
if [ -z "$PRODUCT_NAME" ]; then
  ...
  cd $HOME/Stanford-Drupal-Profile; git checkout $DRUPAL_PROFILE_BRANCH; git pull; cd $HOME
  ...
  cd $HOME/stanford-jumpstart-deployer; git checkout $DEPLOYER_BRANCH; git pull; cd $HOME
