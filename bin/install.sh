...
if [ -z "$PRODUCT_NAME" ]; then
  ...
  if [ -z "$(ls -A $HOME/stanford-jumpstart-deployer)" ]; then git clone --depth 1 -b proboci https://github.com/SU-SWS/stanford-jumpstart-deployer.git $HOME/stanford-jumpstart-deployer; fi
